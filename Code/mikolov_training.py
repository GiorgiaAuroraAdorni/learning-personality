...
from mikolov_model import model_fn
from mikolov_model import create_input_fn
...
def main(argv):
    ...
    config = tf.estimator.RunConfig(model_dir='Model/Mikolov/NEmb002/',
    ...
    file = open("Model_Dataset/Mikolov/NEmb002.txt", "w")
    ids = 0
